...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        ...
        TrelloCard mappedTrelloCard = new TrelloCard("Test Card", "Description", "top", "1");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "Test Card", "http://test.com", null);

        when(trelloMapper.mapToCard(trelloCardDto)).thenReturn(mappedTrelloCard);
        when(trelloService.createTrelloCard(trelloMapper.mapToCardDto(mappedTrelloCard))).thenReturn(createdTrelloCardDto);
        ...
        assertEquals("Test Card", newCard.getName());
